...
* __Memory:__ 2048 MB (4096MB recommended)
* __Free disc space:__ 500 MB (4096 recommended)
...
| Ubuntu 16.04 Trusty             | ubuntu-16.04 | systemd     |
...
* __Runtime:__ [Ruby](https://www.ruby-lang.org/en/) Version >= 2.2.
...
* __Cache:__ [Memcached](https://www.memcached.org/) Version >= 1.4. (Optional)
...
* [Microsoft Internet
  Explorer](http://windows.microsoft.com/en-us/internet-explorer/download-ie) (Version >= 11)
* [Google Chrome](https://www.google.com/chrome/browser/desktop/) (Stable Version)
