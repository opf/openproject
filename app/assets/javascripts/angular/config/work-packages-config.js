...
.constant('AVAILABLE_WORK_PACKAGE_FILTERS', {
  ...
  responsible_id: {type: 'list_model', modelName: 'user', order: 6, locale_name: 'watcher'},
  fixed_version_id: {type: 'list_model', modelName: 'version', order: 7, locale_name: 'version'},
