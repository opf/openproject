...
module BasicData
  class RoleSeeder < Seeder
    ...
    def member
      { name: I18n.t(:default_role_member), position: 3, permissions: %i[
        view_work_packages
    ...
    def non_member
      { name: I18n.t(:default_role_non_member), permissions: %i[
        view_work_packages
        view_calendar
        comment_news
        browse_repository
    ...
    def anonymous
      { name: I18n.t(:default_role_anonymous), permissions: %i[
        view_work_packages
        browse_repository
        view_changesets
        view_wiki_pages
