...
module Queries::WorkPackages
  ...
  register.filter Query, filters_module::RelatesToFilter
  ...
  register.filter Query, filters_module::BlockedByFilter
  ...
  register.filter Query, filters_module::RequiredByFilter
