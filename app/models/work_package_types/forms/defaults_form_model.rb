...
module WorkPackageTypes
  module Forms
    class DefaultsFormModel
      ...
      def stimulus_data
        open_preview_dialog = Rails.application
                                   .routes
                                   .url_helpers
                                   .subject_preview_dialog_type_defaults_path(type_id: @variant.type_id)
        {
          controller: "admin--subject-configuration",
          admin__subject_configuration_hide_pattern_input_value: subject_configuration == :manual,
          admin__subject_configuration_preview_url_value: open_preview_dialog
        }
      end
