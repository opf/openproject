  ...
  module Patterns
    class TokenPropertyMapper
      ...
      BASE_ATTRIBUTE_TOKENS = [
        ...
        attribute(:category, -> { Setting::WorkPackageMultipleCategories.active? ? WorkPackage.human_attribute_name(:categories) : WorkPackage.human_attribute_name(:category) }, ->(wp) { wp.categories }, ARRAY),
        ...
        attribute(:parent_category, -> { Setting::WorkPackageMultipleCategories.active? ? WorkPackage.human_attribute_name(:categories) : WorkPackage.human_attribute_name(:category) }, ->(parent) { parent.categories }, ARRAY),
