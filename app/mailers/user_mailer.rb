...
class UserMailer < BaseMailer
  ...
  class << self
    ...
    def method_missing(method, *args)
      ...
      # Avoid trying to generate jobs that should be handled by action_methods
      return super if immediate?(method)

      target = immediate(method)
      return super unless respond_to?(target, true)
    ...
    def respond_to_missing?(method, include_private = false)
      super || super(immediate(method), include_private)
    end
  end
  ...
  def test_mail!(user)
    ...
    with_locale_for(user) do
      mail to: "\"#{user.name}\" <#{user.mail}>", subject: 'OpenProject Test', template_name: 'test_mail'
    end
  end
  ...
  def work_package_added!(user, journal, author)
    User.execute_as user do
      ...
      with_locale_for(user) do
        mail_for_author author, to: user.mail, subject: subject_for_work_package(work_package), template_name: 'work_package_added'
      end
    end
  end
  ...
  def work_package_updated!(user, journal, author = User.current)
    User.execute_as user do
      ...
      with_locale_for(user) do
        mail_for_author author, to: user.mail, subject: subject_for_work_package(work_package), template_name: 'work_package_updated'
      end
    end
  end
  ...
  def work_package_watcher_added!(work_package, user, watcher_setter)
    User.execute_as user do
      ...
      with_locale_for(user) do
        mail to: user.mail, subject: subject_for_work_package(work_package), template_name: 'work_package_watcher_added'
      end
    end
  end
  ...
  def password_lost!(token)
    ...
    with_locale_for(user) do
      ...
      mail to: user.mail, subject: subject, template_name: 'password_lost'
    end
  end
  ...
  def copy_project_failed!(user, source_project, target_project_name, errors)
    ...
    with_locale_for(user) do
      ...
      mail to: user.mail, subject: subject, template_name: 'copy_project_failed'
    end
  end
  ...
  def copy_project_succeeded!(user, source_project, target_project, errors)
    ...
    with_locale_for(user) do
      ...
      mail to: user.mail, subject: subject, template_name: 'copy_project_succeeded'
    end
  end
  ...
  def news_added!(user, news, author)
    ...
    with_locale_for(user) do
      ...
      mail_for_author author, to: user.mail, subject: subject,  template_name: 'news_added'
    end
  end
  ...
  def user_signed_up!(token)
    ...
    with_locale_for(user) do
      ...
      mail to: user.mail, subject: subject, template_name: 'user_signed_up'
    end
  end
  ...
  def news_comment_added!(user, comment, author)
    ...
    with_locale_for(user) do
      ...
      mail_for_author author, to: user.mail, subject: subject,  template_name: 'news_comment_added'
    end
  end
  ...
  def wiki_content_added!(user, wiki_content, author)
    ...
    with_locale_for(user) do
      ...
      mail_for_author author, to: user.mail, subject: subject,  template_name: 'wiki_content_added'
    end
  end
  ...
  def wiki_content_updated!(user, wiki_content, author)
    ...
    with_locale_for(user) do
      ...
      mail_for_author author, to: user.mail, subject: subject, template_name: 'wiki_content_updated'
    end
  end
  ...
  def message_posted!(user, message, author)
    ...
    with_locale_for(user) do
      ...
      mail_for_author author, to: user.mail, subject: subject, template_name: 'message_posted'
    end
  end
  ...
  def account_activated!(user)
    ...
    with_locale_for(user) do
      subject = t(:mail_subject_register, value: Setting.app_title)
      mail to: user.mail, subject: subject, template_name: 'account_activated'
    end
  end
  ...
  def account_information!(user, password)
    ...
    with_locale_for(user) do
      subject = t(:mail_subject_register, value: Setting.app_title)
      mail to: user.mail, subject: subject, template_name: 'account_information'
    end
  end
  ...
  def account_activation_requested!(admin, user)
    ...
    with_locale_for(admin) do
      ...
      mail to: admin.mail, subject: subject, template_name: 'account_activation_requested'
    end
  end
  ...
  def reminder_mail!(user, issues, days)
    ...
    with_locale_for(user) do
      ...
      mail to: user.mail, subject: subject, template_name: 'reminder_mail'
    end
  end
  ...
  def activation_limit_reached!(user_email, admin)
    ...
    with_locale_for(admin) do
      mail to: admin.mail, subject: t("mail_user_activation_limit_reached.subject"), template_name: 'activation_limit_reached'
    end
  end
