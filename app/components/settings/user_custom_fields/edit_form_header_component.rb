  ...
  module UserCustomFields
    class EditFormHeaderComponent < ApplicationComponent
      ...
      def tabs
        tabs = [
          {
            name: "user_custom_field_edit",
            path: edit_admin_settings_user_custom_field_path(@custom_field),
        ...
        tabs <<
          {
            ...
            path: attribute_help_text_admin_settings_user_custom_field_path(@custom_field),
