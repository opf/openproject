...
module WorkPackageTypes
  module ReuseMode
    class DependentsBoxComponent < ApplicationComponent
      ...
      def title
        return t("types.edit.reuse_mode.inherited_by.blank.title") unless any_dependents?

        t("types.edit.reuse_mode.inherited_by.title", count: dependents_count)
      end

      def description
        return t("types.edit.reuse_mode.inherited_by.blank.description") unless any_dependents?

        t("types.edit.reuse_mode.inherited_by.description", count: dependents_count)
      end
