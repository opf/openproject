...
module Projects::Settings::WorkPackages::Types::Variants
  # Copying a workflow onto the variants a project owns. The candidates the parent offers are
  # already limited to what the addressed variant may exchange configuration with, so only the
  # authorization and the lookup change here.
  class WorkflowCopiesController < ::Workflows::CopiesController
    ...
    skip_before_action :set_other_variants
    skip_before_action :set_all_roles
