...
module Projects
  class BaseContract < ::ModelContract
    ...
    attribute :limit_custom_fields_validation_to_section_id
    # `limit_custom_fields_validation_to_section_id` used in Projects::ActsAsCustomizablePatches in order to
