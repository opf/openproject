...
module Shared
  module ServiceContext
    ...
    def in_context(model, send_notifications: nil, &block)
      if model
    ...
    def in_mutex_context(model, send_notifications: nil, &block)
      result = nil
    ...
    def in_user_context(send_notifications: nil, &block)
      result = nil
