...
module McpTools
  class UpdateWorkPackageRelation < Base
    default_title "Update work package relation"
    default_description "Update an existing relation between two work packages."
    ...
    input_schema(
      ...
      properties: {
        ...
        type: {
          type: :string,
          description: "The kind of relation. Follows and precedes should only be used " \
