...
module McpTools
  class DeleteWorkPackageRelation < Base
    default_title "Delete work package relation"
    default_description "Delete an existing relation between two work packages."
    ...
    input_schema(
      ...
      properties: {
        id: {
          type: :number,
          description: "The ID of the relation to be removed."
        }
      }
    )
