...
module OutboundRequestAuthentication
  module Strategies
    class ClientCredentials
      ...
      def call
        token = @client.access_token!(scope: @config.client_credential_scope)
        ServiceResult.success(result: OutboundRequestAuthentication::AuthenticationBlob::OAuthToken.new(token:))
      rescue => _e
