...
module ProjectsHelper
  ...
  def link_to_version(version, html_options = {}, options={})
    ...
    link_to_if version.visible?(User.current), options[:before_text].to_s.html_safe + format_version_name(version), { :controller => '/versions', :action => 'show', :id => version }, html_options
  end
