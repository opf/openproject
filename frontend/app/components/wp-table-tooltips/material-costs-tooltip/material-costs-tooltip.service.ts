...
function materialCostsTooltipService(opTooltip) {
  return opTooltip({
    templateUrl: '/components/wp-table-tooltips/material-costs-tooltip/material-costs-tooltip.service.html',
    controller: MaterialCostsController
  });
}

wpDirectivesModule.factory('materialCostsTooltip', materialCostsTooltipService);
