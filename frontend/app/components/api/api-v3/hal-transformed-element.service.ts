  ...
  return class HalTransformedElement {
    ...
    protected transform() {
      ...
      Object.defineProperties(this.element, {
        ...
        /**
         * Return plain object with _embedded and _links properties.
         * If a linked property was updated, set the _links[propertyName] to the
         * current value.
         * @method
         */
        //TODO: Handle _embedded properties, if required
        data: {
          value: () => {
