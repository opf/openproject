...
@Directive({selector: 'ng1-wp-edit-field-group-wrapper'})
export class Ng1WorkPackageEditFieldGroupController extends UpgradeComponent implements OnInit, OnChanges, DoCheck, OnDestroy {

  @Input('workPackage') workPackage:WorkPackageResourceInterface;

  constructor(@Inject(ElementRef) elementRef:ElementRef, @Inject(Injector) injector:Injector) {
    // We must pass the name of the directive as used by AngularJS to the super
    super('wpEditFieldGroup', elementRef, injector);
  }
