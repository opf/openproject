...
export class WidgetTimeEntriesCurrentUserComponent extends AbstractTurboWidgetComponent {
  override frameId = 'grids-widgets-time-entries-current-user';

  override name = 'time_entries_current_user';
}
