...
import { Conditions } from '../op-autocompleter.component';
...
export class OPAutocompleterService extends UntilDestroyedMixin {
  ...
  public loadAvailable(matching:string, resource:dataType, conditions?:Conditions[], searchKey?:string):Observable<HalResource[]> {
  ...
  protected createFilters(conditions:Conditions[], matching:string, searchKey?:string) {
  ...
  public loadData(matching:string,  resource:dataType, conditions?:Conditions[], searchKey?:string) {
    switch (resource) {
      // TODO
