...
import { TableEventComponent, TableHandlerRegistry } from 'core-app/features/work_packages/components/wp-fast-table/handlers/table-handler-registry';
...
import { createScrollSync } from "core-app/features/work_packages/components/wp-table/wp-table-scroll-sync";
import { WpTableHoverSync } from "core-app/features/work_packages/components/wp-table/wp-table-hover-sync";
