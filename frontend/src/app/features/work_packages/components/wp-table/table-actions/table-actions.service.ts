...
import { OpDetailsTableAction } from 'core-app/features/work_packages/components/wp-table/table-actions/actions/details-table-action';
import { OpContextMenuTableAction } from 'core-app/features/work_packages/components/wp-table/table-actions/actions/context-menu-table-action';
