...
import { WorkPackageTimelineCell } from 'core-app/features/work_packages/components/wp-table/timeline/cells/wp-timeline-cell';
import { selectorTimelineSide } from 'core-app/features/work_packages/components/wp-table/wp-table-scroll-sync';
...
import { WorkPackagesTableComponent } from 'core-app/features/work_packages/components/wp-table/wp-table.component';
import {
  groupIdFromIdentifier,
  groupTypeFromIdentifier
} from 'core-app/features/work_packages/components/wp-fast-table/builders/modes/grouped/grouped-rows-helpers';
