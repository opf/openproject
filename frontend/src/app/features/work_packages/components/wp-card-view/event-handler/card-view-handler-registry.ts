...
import { CardClickHandler } from "core-app/features/work_packages/components/wp-card-view/event-handler/click-handler";
import { CardDblClickHandler } from "core-app/features/work_packages/components/wp-card-view/event-handler/double-click-handler";
import { CardRightClickHandler } from "core-app/features/work_packages/components/wp-card-view/event-handler/right-click-handler";
import {
