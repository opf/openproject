...
import { CardEventHandler } from "core-app/features/work_packages/components/wp-card-view/event-handler/card-view-handler-registry";
...
import { uiStateLinkClass } from "core-app/features/work_packages/components/wp-fast-table/builders/ui-state-link-builder";
