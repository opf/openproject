...
import { locateTableRowByIdentifier } from 'core-app/features/work_packages/components/wp-fast-table/helpers/wp-table-row-helpers';
...
import { TableActionRenderer } from 'core-app/features/work_packages/components/wp-fast-table/builders/table-action-renderer';
...
import {
  ...
  internalSortColumn
} from "core-app/features/work_packages/components/wp-fast-table/builders/internal-sort-columns";
