...
import { scrollTableRowIntoView } from 'core-app/features/work_packages/components/wp-fast-table/helpers/wp-table-row-helpers';
...
import {
  ...
  hierarchyGroupClass,
  hierarchyRootClass
} from "core-app/features/work_packages/components/wp-fast-table/helpers/wp-table-hierarchy-helpers";
import { indicatorCollapsedClass } from "core-app/features/work_packages/components/wp-fast-table/builders/modes/hierarchy/single-hierarchy-row-builder";
