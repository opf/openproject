...
import { HighlightingTransformer } from "core-app/features/work_packages/components/wp-fast-table/handlers/state/highlighting-transformer";
import { DragAndDropTransformer } from "core-app/features/work_packages/components/wp-fast-table/handlers/state/drag-and-drop-transformer";
import {
...
import { WorkPackageFocusContext } from "core-app/features/work_packages/components/wp-table/wp-table.component";
import { GroupFoldTransformer } from "core-app/features/work_packages/components/wp-fast-table/handlers/state/group-fold-transformer";
