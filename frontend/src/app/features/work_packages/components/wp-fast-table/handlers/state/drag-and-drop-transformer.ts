...
import { isInsideCollapsedGroup } from "core-app/features/work_packages/components/wp-fast-table/helpers/wp-table-row-helpers";
import { collapsedGroupClass } from "core-app/features/work_packages/components/wp-fast-table/helpers/wp-table-hierarchy-helpers";
