...
import { InAppNotificationDateAlertsUpsaleComponent } from './center/upsale/in-app-notification-date-alerts-upsale.component';
...
@NgModule({
  declarations: [
    ...
    IanMenuComponent,
    EmptyStateComponent,
    InAppNotificationDateAlertsUpsaleComponent,
  ],
  imports: [
    OPSharedModule,
    // Routes for /backlogs
