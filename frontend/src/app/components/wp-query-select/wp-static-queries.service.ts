  ...
  public get all():IAutocompleteItem[] {
    let items = [
      ...
      },
      {
        ...
        query_props: `{"c":["id","type","status","startDate","dueDate","subject"],"tv":true,"tzl":"auto","tll":"{\\"left\\":\\"startDate\\",\\"right\\":\\"dueDate\\",\\"farRight\\":null}","hi":true,"g":"","t":"startDate:asc","f":[{"n":"status","o":"o","v":[]}]}`
      },
      {
