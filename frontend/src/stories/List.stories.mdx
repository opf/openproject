...
<Canvas>
  <Story name="With Links">{Template.bind(SbListWithLinksExample)}</Story>
</Canvas>

<Canvas>
  <Story name="With Checkboxes">{Template.bind(SbListWithCheckboxesExample)}</Story>
</Canvas>
...
<Canvas>
  <Story name="Compact">{Template.bind(SbListCompactExample)}</Story>
</Canvas>
