...
// Keeps a collaboration cursor's label inside the editor instead of letting it clip at the
// top or right edge. Remove this extension once BlockNote ships a fix for
// https://github.com/TypeCellOS/BlockNote/issues/3079.
