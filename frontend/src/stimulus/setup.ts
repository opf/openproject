...
import MngtChatPanelController from './controllers/dynamic/mngt/chat-panel.controller';
...
OpenProjectStimulusApplication.preregister('mngt--chat-panel', MngtChatPanelController);
