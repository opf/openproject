...
// import * as Turbo from '@hotwired/turbo'; // when importing like this, Turbo streams don't work
...
// Turbo.session.drive = false; // comment temporarily as the import above doesn't work 
