...
module OpenProject::GithubIntegration
  ...
  module NotificationHandlers
    class << self
      ...
      # Returns:
      #   Array<int>
      def extract_work_package_ids(source)
      ...
      def comment_on_referenced_work_packages(text, payload)
      ...
      def notes_for_pull_request_payload(payload)
        key = {
          'opened' => 'opened',
          'reopened' => 'opened',
          'closed' => 'closed',
