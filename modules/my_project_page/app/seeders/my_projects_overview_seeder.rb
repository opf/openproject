  ...
  module MyProjectPage
    class MyProjectsOverviewSeeder < Seeder
      ...
      def seed_data!
        ...
        Array(translate_with_base_url("seeders.#{OpenProject::Configuration['edition']}.demo_data.projects")).each do |key, project|
      ...
      def demo_projects_exist?
        identifiers = Array(I18n.t("seeders.#{OpenProject::Configuration['edition']}.demo_data.projects"))
