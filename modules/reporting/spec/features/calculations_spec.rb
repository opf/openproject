...
describe 'Cost report calculations', type: :feature, js: true do
  ...
  let!(:hourly_rate2) { create :default_hourly_rate, user: user, rate: 5.00, valid_from: 2.years.ago }
  let!(:hourly_rate3) { create :default_hourly_rate, user: user, rate: 10.00, valid_from: 3.years.ago }
