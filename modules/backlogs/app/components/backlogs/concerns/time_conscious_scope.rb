...
module Backlogs::Concerns
  # Offers discoverability and queries for sprints, depending on if they're live or historic.
  #
  # Requires `sprint` in the including component.
  module TimeConsciousScope
    private
