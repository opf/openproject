...
RSpec.describe Backlogs::Target do
  describe "SprintId" do
    ...
    it { is_expected.to have_attributes(id: 42, list_type: "sprint", list_id: 42) }
  ...
  describe "BucketId" do
    ...
    it { is_expected.to have_attributes(id: 13, list_type: "backlog_bucket", list_id: 13) }
  ...
  describe "InboxId" do
    ...
    it { is_expected.to have_attributes(list_type: "inbox", list_id: nil) }
