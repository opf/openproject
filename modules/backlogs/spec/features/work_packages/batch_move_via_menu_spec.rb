...
RSpec.describe "Move selected backlog cards to a position via their menu",
  ...
  it "moves a contiguous block to the top and then down while preserving its order" do
    ...
    backlogs_page.expect_sprint_items_in_order(
      sprint,
      items: [stories[2], stories[3], stories[0], stories[1], stories[4], stories[5]]
    )
    ...
    backlogs_page.expect_sprint_items_in_order(
      sprint,
      items: [stories[0], stories[2], stories[3], stories[1], stories[4], stories[5]]
    )
  ...
  it "moves a contiguous block to the bottom and then up while preserving its order" do
    ...
    backlogs_page.expect_sprint_items_in_order(
      sprint,
      items: [stories[0], stories[1], stories[4], stories[5], stories[2], stories[3]]
    )
    backlogs_page.expect_no_selected_cards
    ...
    backlogs_page.expect_sprint_items_in_order(
      sprint,
      items: [stories[0], stories[1], stories[4], stories[2], stories[3], stories[5]]
    )
  ...
  it "keeps the singular menu contract for an unselected card" do
    ...
    backlogs_page.expect_sprint_items_in_order(
      sprint,
      items: [stories[1], stories[0], stories[2]]
    )
  ...
  it "moves a contiguous confined block within its list" do
    ...
    backlogs_page.expect_sprint_items_in_order(
      sprint,
      items: [stories[0], stories[3], stories[1], stories[2]]
    )
  ...
  it "rolls a rejected move back and preserves the selected block" do
    ...
    backlogs_page.expect_sprint_items_in_order(sprint, items: stories)
