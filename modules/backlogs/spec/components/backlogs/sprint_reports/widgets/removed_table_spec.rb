...
RSpec.describe Backlogs::SprintReports::Widgets::RemovedTable,
               type: :component,
  ...
  context "when the sprint has no dates set" do
    ...
    include_examples "renders a blankslate",
                     description: "Sprint start and finish dates are necessary to show removed work packages."
  end
  ...
  context "when the sprint has not started" do
    ...
    include_examples "renders a blankslate",
                     description: "Removed work packages will appear here after the sprint starts."
  end

  context "when nothing was removed" do
    let(:removed_after_start_ids) { [] }
