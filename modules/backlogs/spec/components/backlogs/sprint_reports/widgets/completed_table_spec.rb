...
RSpec.describe Backlogs::SprintReports::Widgets::CompletedTable,
               type: :component,
  ...
  context "when the sprint has no dates set" do
    ...
    include_examples "renders a blankslate",
                     description: "Sprint start and finish dates are necessary to show completed work packages."
  end
  ...
  context "when the sprint has not started" do
    ...
    include_examples "renders a blankslate",
                     description: "Completed work packages will appear here after the sprint starts."
  end
  ...
  context "when nothing is completed" do
    ...
    include_examples "renders a blankslate",
                     description: "Work packages that were completed in the sprint will appear here."
  end
