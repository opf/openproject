...
RSpec.describe "ResourceAllocations requests",
  ...
  describe "POST refresh_form (missing working hours warning)" do
    ...
    it "streams the warning naming the days the user's schedule does not cover" do
      ...
      refresh(principal_id: assignee.id)
    ...
    it "streams an empty banner for a filter-based allocation, which has no user yet" do
      refresh(principal_id: nil)
