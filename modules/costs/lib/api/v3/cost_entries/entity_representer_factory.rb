      ...
      module EntityRepresenterFactory
        ...
        def create_getter_lambda(name)
          ->(*) {
            ...
            next unless API::V3::CostEntries::EntityRepresenterFactory.entity_visible?(instance, current_user)

            ::API::V3::CostEntries::EntityRepresenterFactory.create(instance, current_user:)
          }
        end
