...
module Costs
  class Engine < ::Rails::Engine
    ...
    extend_api_response(:v3, :work_packages, :work_package) do
      ...
      link :logCosts,
           cache_if: -> {
             current_user.allowed_in_project?(:log_costs, context: represented.project) ||
             current_user.allowed_in_project?(:log_own_costs, context: represented.project)
           } do
      ...
      link :showCosts,
           cache_if: -> {
             current_user.allowed_in_project?(:view_cost_entries, context: represented.project) ||
             current_user.allowed_in_project?(:view_own_cost_entries, context: represented.project)
           } do
