...
RSpec.describe HourlyRates::UpdateContract do
  it_behaves_like "an hourly rate contract" do
    let(:rate) { build_stubbed(:hourly_rate, principal:, project:) }
    ...
    context "when the user may edit the hourly rates of the project" do
      ...
      it "rejects turning the rate into a default rate" do
        rate.type = DefaultHourlyRate.name
