    ...
    module InstanceMethods
        ...
        def velocity
            sprints = Sprint.find(:all,
                :conditions => ["project_id = ? and status = 'open' and not(effective_date is null or sprint_start_date is null)", self.id],
            ...
            sprints.each {|sprint|
                ...
                accepted += sprint.stories.select{|s| s.status.is_closed}.length
            }
