  ...
  def render
    ...
    content_tag :td do
      content_tag :div, :id => "#{id_prefix}arg_1", :class => "filter_values" do
        text1 = text_field_tag name, "", :size => 10, :class => "select-small", :id => "#{id_prefix}arg_1_val"
        cal1 = calendar_for("#{id_prefix}arg_1_val")
        span = content_tag :span, :id => "#{id_prefix}arg_2", :class => "between_tags" do
          text2 = text_field_tag "#{name}", "", :size => 10, :class => "select-small", :id => "#{id_prefix}arg_2_val"
