    ...
    module WorkPackages
      class WorkPackageCollectionRepresenter < ::API::Decorators::OffsetPaginatedCollection
        ...
        links :representations do
          representation_formats if current_user_allowed_to_export_work_packages?
        end
        ...
        def current_user_allowed_to_add_work_packages?
          @current_user_allowed_to_add_work_packages ||= if project
        ...
        def current_user_allowed_to_export_work_packages?
          if project
            current_user.allowed_in_project?(:export_work_packages, project)
          else
            current_user.allowed_in_any_project?(:export_work_packages)
          end
        end
