  ...
  module Decorators
    module LinkedResource
      ...
      module ClassMethods
        ...
        #
        # @param show_if [optional, Proc] If the proc returns false, the property does not exist at all: it is neither rendered nor parsed.
        # @param skip_render [optional, Proc] If the proc returns true, neither _link nor _embedded of the resource will be rendered. Writes are still accepted.
