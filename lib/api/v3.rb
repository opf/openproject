...
module API
  module V3
    ...
    # a "hidden uri" instead of a url. This indicates the existence of a value
    # without revealing anything. An example for this is the parent project which might be
    # invisible to a user.
    # In case a "hidden uri" is provided as a link, the current value is not
    ...
    URN_HIDDEN = "#{URN_PREFIX}hidden".freeze
  end
end
