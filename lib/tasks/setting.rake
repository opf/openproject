...
namespace :setting do
  ...
  task available_envs: :environment do
    # Prints the values effective on this instance. The documented list, which
    # masks the defaults that differ per instance, is generated by `docs:env_vars`.
    OpenProject::EnvironmentVariablesDocumentation.sorted_definitions.each do |env_name, definition|
