    ...
    def replace_toc(text, headings)
      text.gsub!(TOC_RE) do
        if headings.empty?
          ...
          out << "<legend class='form--fieldset-legend' title='" + l(:description_toc_toggle) + "' onclick='toggleFieldset(this);'><a class='icon-context icon-pulldown-arrow1' href='javascript:'>#{l(:label_table_of_contents)}</a></legend><div>"
