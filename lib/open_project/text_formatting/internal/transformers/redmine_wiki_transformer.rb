...
module OpenProject::TextFormatting::Internal::Transformers
  ...
  class RedmineWikiTransformer < TextTransformer
    def process(fragment, format: nil, object: nil, attr: nil, edit: false, **_options)
      fragment.xpath('text()|*//text()').each do |node|
        text = Redmine::WikiFormatting.to_html(format, node.text, object: object,
                                               attribute: attr, edit: edit)
        if node.text != text
