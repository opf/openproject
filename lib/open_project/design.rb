...
module OpenProject
  class Design
    DEFAULTS = {
      ...
      'button--highlight-font-color'                         => "$content-link-color",
      'button--highlight-background-color'                   => "$body-background",
      'button--highlight-background-hover-color'             => "darken($body-background, 5)",
