...
describe Redmine::WikiFormatting::Macros, type: :helper do
  ...
  it 'should macro child pages' do
    expected =  "<p><ul class=\"pages-hierarchy -with-hierarchy -hierarchy-expanded\">" +
                "<li><span class=\"tree-menu--item\" slug=\"child-1\"><span class=\"tree-menu--hierarchy-span\">" +
                "</span><a class=\"tree-menu--title ellipsis\" href=\"/projects/ecookbook/wiki/child-1\">Child 1</a>" +
                "</span></li><li><span class=\"tree-menu--item\" slug=\"child-2\">" +
                "<span class=\"tree-menu--hierarchy-span\">" +
                "</span><a class=\"tree-menu--title ellipsis\" href=\"/projects/ecookbook/wiki/child-2\">Child 2</a>" +
                "</span></li></ul></p>"
  ...
  it 'should macro child pages with option' do
    expected =  "<p><ul class=\"pages-hierarchy -with-hierarchy -hierarchy-expanded\">" +
                "<li><span class=\"tree-menu--item\" slug=\"another-page\">" +
                "<span class=\"tree-menu--hierarchy-span\">" +
                ...
                "</a></span><a class=\"tree-menu--title ellipsis\" href=\"/projects/ecookbook/wiki/another-page\">Another page</a>" +
                "</span><ul class=\"pages-hierarchy -with-hierarchy -hierarchy-expanded\"><li>" +
                "<span class=\"tree-menu--item\" slug=\"child-1\"><span class=\"tree-menu--hierarchy-span\"></span>" +
                "<a class=\"tree-menu--title ellipsis\" href=\"/projects/ecookbook/wiki/child-1\">Child 1</a></span></li>" +
                "<li><span class=\"tree-menu--item\" slug=\"child-2\"><span class=\"tree-menu--hierarchy-span\"></span>" +
                "<a class=\"tree-menu--title ellipsis\" href=\"/projects/ecookbook/wiki/child-2\">Child 2</a></span>" +
                "</li></ul></li></ul></p>"
