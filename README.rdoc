= OpenProject {<img src="https://travis-ci.org/opf/openproject.png?branch=feature/rails3" alt="Build Status" />}[https://travis-ci.org/opf/openproject] {<img src="https://gemnasium.com/opf/openproject.png" alt="Dependency Status" />}[https://gemnasium.com/opf/openproject]
...
Although this is the main development branch, it is *not* a stable code base. For production usage, we recommend to use the master-branch.

== What we do?

OpenProject is a web-based project management software, driven by an active group of open source enthusiasts: software engineers, project managers, creatives, and consultants. OpenProject is supported by companies as well as individuals. What we share? It’s the vision to build great project collaboration software based on open source.
...
You will find an {installation guide}[https://www.openproject.org/projects/support/wiki/Installation] online.
...
* OpenProject Support Project - https://www.openproject.org/projects/support
...
In case you find a bug or need a feature, please report at https://www.openproject.org/projects/openproject/
