...
RAW
  ...
  it 'should due_date_distance_in_words' do
  ...
  it 'should link_to_user' do
    t = link_to_user(@admin)
    assert_equal "<a href=\"/users/#{ @admin.id }\">#{ @admin.name }</a>", t
  end

  it 'should link_to_user_should_not_link_to_locked_user' do
  ...
  it 'should link_to_user_should_not_link_to_anonymous' do
    user = User.anonymous
