...
describe TimeEntry do
  ...
  it 'should hours_should_default_to_nil' do
    assert_nil TimeEntry.new.hours
  end

  it 'should spent_on_with_blank' do
    c = TimeEntry.new
    c.spent_on = ''
    assert_nil c.spent_on
  end

  it 'should spent_on_with_nil' do
    c = TimeEntry.new
    c.spent_on = nil
    assert_nil c.spent_on
  end

  it 'should spent_on_with_string' do
    c = TimeEntry.new
    c.spent_on = "2011-01-14"
    assert_equal Date.parse("2011-01-14"), c.spent_on
  end

  it 'should spent_on_with_invalid_string' do
    c = TimeEntry.new
    c.spent_on = "foo"
    assert_nil c.spent_on
  end

  it 'should spent_on_with_date' do
    c = TimeEntry.new
    c.spent_on = Date.today
    assert_equal Date.today, c.spent_on
  end

  it 'should spent_on_with_time' do
    c = TimeEntry.new
    c.spent_on = Time.now
    assert_equal Date.today, c.spent_on
  end
  ...
  context "#earliest_date_for_project" do
    ...
    context "without a project" do
      it "return the lowest spent_on value that is visible to the current user" do
        assert_equal "2007-03-12", TimeEntry.earliest_date_for_project.to_s
      end
    end

    context "with a project" do
      it "return the lowest spent_on value that is visible to the current user for that project and it's subprojects only" do
  ...
  context "#latest_date_for_project" do
    ...
    context "without a project" do
      it "return the highest spent_on value that is visible to the current user" do
        assert_equal "2010-01-01", TimeEntry.latest_date_for_project.to_s
      end
    end

    context "with a project" do
      it "return the highest spent_on value that is visible to the current user for that project and it's subprojects only" do
