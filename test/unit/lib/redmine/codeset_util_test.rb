...
describe Redmine::CodesetUtil do
  it 'should to_utf8_by_setting_from_latin1' do
  ...
  it 'should to_utf8_by_setting_from_euc_jp' do
  ...
  it 'should to_utf8_by_setting_should_be_converted_all_latin1' do
  ...
  it 'should to_utf8_by_setting_invalid_utf8_sequences_should_be_stripped' do
  ...
  it 'should to_utf8_by_setting_invalid_utf8_sequences_should_be_stripped_ja_jis' do
