...
describe Redmine::UnifiedDiff do
  ...
  it 'should side_by_side_partials' do
  ...
  it 'should line_starting_with_dashes' do
...
DIFF
  ...
  it 'should one_line_new_files' do
    diff = Redmine::UnifiedDiff.new(<<-DIFF
