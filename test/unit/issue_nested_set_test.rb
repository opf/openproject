...
describe "IssueNestedSet" do
  ...
  it 'should creating_a_child_in_different_project_should_not_validate_unless_allowed' do
  ...
  it 'should creating_a_child_in_different_project_should_validate_if_allowed' do
  ...
  it 'should move_a_child_with_descendants_to_another_project' do
    Setting.cross_project_work_package_relations = "0"
  ...
  it 'should invalid_move_to_another_project' do
    parent1 = create_issue!
    child =   create_issue!(:parent_id => parent1.id)
  ...
  it 'should moving_an_to_a_descendant_should_not_validate' do
    parent1 = create_issue!
  ...
  it 'should moving_an_issue_should_keep_valid_relations_only' do
    issue1 = create_issue!
    issue2 = create_issue!
  ...
  it 'should destroy_should_destroy_children' do
    issue1 = create_issue!
    issue2 = create_issue!
    issue3 = create_issue!(:parent_id => issue2.id)
  ...
  it 'should destroy_parent_work_package_updated_during_children_destroy' do
    parent = create_issue!
  ...
  it 'should destroy_child_issue_with_children' do
  ...
  it 'should destroy_issue_with_grand_child' do
    parent = create_issue!
  ...
  it 'should parent_priority_should_be_the_highest_child_priority' do
  ...
  it 'should parent_dates_should_be_lowest_start_and_highest_due_dates' do
    parent = create_issue!
  ...
  it 'should parent_done_ratio_should_be_average_done_ratio_of_leaves' do
    parent = create_issue!
  ...
  it 'should parent_done_ratio_should_be_weighted_by_estimated_times_if_any' do
    parent = create_issue!
  ...
  it 'should parent_estimate_should_be_sum_of_leaves' do
    parent = create_issue!
  ...
  it 'should move_parent_updates_old_parent_attributes' do
  ...
  it 'should project_copy_should_copy_issue_tree' do
