...
describe WikiController do
  ...
  it 'show_unexistent_page_without_edit_right' do
    get :show, :project_id => 1, :id => 'Unexistent page'
    assert_response 404
  end

  it 'show_unexistent_page_with_edit_right' do
  ...
  it 'create_page_with_attachments' do
    @request.session[:user_id] = 2
  ...
  it 'update_page_with_failure' do
    @request.session[:user_id] = 2
    assert_no_difference 'WikiPage.count' do
      assert_no_difference 'WikiContent.count' do
  ...
  it 'update_stale_page_should_not_raise_an_error' do
  ...
  it 'history_with_one_version' do
    FactoryGirl.create :wiki_content_journal,
                       journable_id: 2,
                       data: FactoryGirl.build(:journal_wiki_content_journal,
                                               text: "h1. Another page\n\n\nthis is a link to ticket: #2")
  ...
  it 'destroy_parent_with_nullify' do
    @request.session[:user_id] = 2
  ...
  it 'destroy_parent_with_cascade' do
    @request.session[:user_id] = 2
  ...
  it 'destroy_parent_with_reassign' do
    @request.session[:user_id] = 2
    assert_difference('WikiPage.count', -1) do
  ...
  it 'index_should_include_atom_link' do
    get :index, :project_id => 'ecookbook'
  ...
  context "GET :export" do
    context "with an authorized user to export the wiki" do
      ...
      it "export all of the wiki pages to a single html file" do
  ...
  it 'show_page_with_edit_link' do
    @request.session[:user_id] = 2
  ...
  it 'show_page_without_edit_link' do
  ...
  it 'edit_protected_page_by_nonmember' do
  ...
  it 'edit_protected_page_by_member' do
    @request.session[:user_id] = 2
    get :edit, :project_id => 1, :id => 'CookBook_documentation'
    assert_response :success
    assert_template 'edit'
  ...
  it 'history_of_non_existing_page_should_return_404' do
