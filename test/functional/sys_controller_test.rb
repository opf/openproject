...
describe SysController do
  ...
  it 'projects_with_repository_enabled' do
    get :projects
  ...
  it 'create_project_repository' do
  ...
  it 'wrong_key_should_respond_with_403_error' do
