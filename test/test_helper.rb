...
RSpec.configure do |config|
  ...
  config.include RSpec::Rails::ControllerExampleGroup, file_path: %r(test/functional)
  config.include Shoulda::Matchers::ActionController, file_path: %r(test/functional)
  config.extend Shoulda::Matchers::ActionController, file_path: %r(test/functional)

  config.include RSpec::Rails::RequestExampleGroup, file_path: %r(test/integration)
  config.include Shoulda::Matchers::ActionController, file_path: %r(test/integration)
  config.extend Shoulda::Matchers::ActionController, file_path: %r(test/integration)
