...
describe Timelines::TimelinesPlanningElementStatusesController do
  ...
  describe 'index.xml' do
    ...
    describe 'with no planning element statuses available' do
      ...
      it 'renders the index builder template' do
        get 'index', :format => 'xml'
        response.should render_template('timelines/timelines_planning_element_statuses/index', :formats => ["api"])
      end
    end
    ...
    describe 'with 3 planning element statuses available' do
      before do
        @created_planning_element_statuses = [
          FactoryGirl.create(:timelines_planning_element_status),
          FactoryGirl.create(:timelines_planning_element_status),
          FactoryGirl.create(:timelines_planning_element_status)
        ]
      end
  ...
  describe 'show.xml' do
    ...
    describe 'with an available planning element status' do
      before do
        @available_planning_element_status = FactoryGirl.create(:timelines_planning_element_status, :id => '1337')
      end
      ...
      it 'renders the show template' do
        get 'show', :id => '1337', :format => 'xml'
        response.should render_template('timelines/timelines_planning_element_statuses/show', :formats => ["api"])
      end
    end
  end
end
