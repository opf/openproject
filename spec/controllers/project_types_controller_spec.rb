...
describe TimelinesProjectTypesController do
  ...
  describe 'index.xml' do
    ...
    describe 'with no project types available' do
      ...
      it 'renders the index builder template' do
        get 'index', :format => 'xml'
        response.should render_template('timelines/project_types/index', :formats=>["api"])
      end
    end
  ...
  describe 'show.xml' do
    ...
    describe 'with an available project type' do
      ...
      it 'renders the show template' do
        get 'show', :id => '1337', :format => 'xml'
        response.should render_template('timelines/project_types/show', :formats=>["api"])
      end
    end
  end
