...
describe Timelines::TimelinesPlanningElementsController do
  # ===========================================================
  # Helpers
      ...
      describe 'w/ the current user having view_planning_elements permissions' do
        ...
        describe 'w/o any planning elements within the project' do
          ...
          it 'renders the index builder template' do
            get 'index', :project_id => project.identifier
            response.should render_template('timelines/timelines_planning_elements/index', :formats => ["html"], :layout => :base)
          end
        end
        ...
        describe 'w/ 3 planning elements within the project' do
          before do
            @created_planning_elements = [
              FactoryGirl.create(:timelines_planning_element, :project_id => project.id),
              FactoryGirl.create(:timelines_planning_element, :project_id => project.id),
              FactoryGirl.create(:timelines_planning_element, :project_id => project.id)
            ]
          end
  ...
  describe 'show.html' do
    ...
    describe 'w/ a valid planning element id' do
      ...
      let(:project) { FactoryGirl.create(:project, :identifier => 'test_project') }
      let(:planning_element) { FactoryGirl.create(:timelines_planning_element, :project_id => project.id) }
      ...
      describe 'w/ a known project' do
        ...
        describe 'w/ the current user being a member' do
          ...
          it 'renders the show builder template' do
            get 'show', :project_id => project.id, :id => planning_element.id
            response.should render_template('timelines/timelines_planning_elements/show', :formats => ["html"], :layout => :base)
          end
        end
      end
    end
      ...
      describe 'w/ a known project' do
        ...
        describe 'w/ the current user being a member' do
          ...
          it 'renders the confirm_destroy view' do
            ...
            response.should render_template('timelines/timelines_planning_elements/confirm_destroy', :formats => ["html"], :layout => :base)
          end
        end
      end
    end
      ...
      describe 'w/ a known project' do
        ...
        describe 'w/ the current user being a member' do
          ...
          it 'redirects to index and adds a notice to the flash' do
            ...
            response.should redirect_to(timelines_project_planning_elements_path(project))
    ...
    describe 'w/ a known project' do
      ...
      describe 'w/ the current user being a member with view_planning_elements permissions' do
        ...
        describe 'w/o any planning elements within the project' do
          ...
          it 'renders the index builder template' do
            get 'index', :project_id => project.id, :format => 'xml'
            response.should render_template('timelines/timelines_planning_elements/index', :formats => ["api"])
          end
        end
    ...
    describe 'w/ multiple known projects' do
      ...
      describe 'w/ the current user being a member with view_planning_elements permissions' do
        ...
        describe 'w/ 1 planning element in project_a and 2 in project_b' do
          before do
            @created_planning_elements = [
              FactoryGirl.create(:timelines_planning_element, :project_id => project_a.id),
              FactoryGirl.create(:timelines_planning_element, :project_id => project_b.id),
              FactoryGirl.create(:timelines_planning_element, :project_id => project_b.id)
            ]
            # adding another planning element, just to make sure, that the
            # result set is properly filtered
            FactoryGirl.create(:timelines_planning_element, :project_id => project_c.id)
          end
  ...
  describe 'create.xml' do
    ...
    def fetch
      post 'create', :project_id => project.identifier,
                     :planning_element => FactoryGirl.build(:timelines_planning_element,
                                                        :project_id => project.id).attributes
    end
    def expect_redirect_to
      Regexp.new(timelines_project_planning_elements_path(project))
    end
    ...
    describe 'w/ a valid planning element id' do
      ...
      describe 'w/ a known project' do
        ...
        describe 'w/ the current user being a member' do
          ...
          it 'renders the show builder template' do
            get 'show', :project_id => project.id, :id => planning_element.id, :format => 'xml'
            response.should render_template('timelines/timelines_planning_elements/show', :formats => ["api"])
          end
        end
      end
    end
  ...
  describe 'update.xml' do
    ...
    let(:project) { FactoryGirl.create(:project, :is_public => false) }
    let(:planning_element) { FactoryGirl.create(:timelines_planning_element,
    ...
    def expect_redirect_to
      timelines_project_planning_element_path(project, planning_element)
    end
    let(:permission) { :edit_planning_elements }
      ...
      describe 'w/ a known project' do
        ...
        describe 'w/ the current user being a member' do
          ...
          it 'renders the destroy builder template' do
            ...
            response.should render_template('timelines/timelines_planning_elements/destroy', :formats => ["api"])
          end
