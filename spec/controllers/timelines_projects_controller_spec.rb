...
describe Timelines::TimelinesProjectsController do
    ...
    describe 'index.xml' do
      describe 'with no project available' do
        ...
        it 'renders the index template' do
          get 'index', :format => 'xml'
          response.should render_template('timelines/timelines_projects/index', :formats => ["api"])
        end
      end
    ...
    describe 'show.xml' do
      ...
      describe 'with an available project' do
        ...
        it 'renders the show template' do
          get 'show', :id => project.identifier, :format => 'xml'
          response.should render_template('timelines/timelines_projects/show', :formats => ["api"])
        end
      end
    end
  end
