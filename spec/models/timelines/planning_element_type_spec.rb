...
describe Timelines::PlanningElementType do
  describe '- Relations ' do
    ...
    describe '#default_planning_element_types' do
      it 'can read disabled_planning_element_types w/ the help of the has_many association' do
        planning_element_type         = FactoryGirl.create(:timelines_planning_element_type)
        default_planning_element_type = FactoryGirl.create(:timelines_default_planning_element_type,
                                                       :planning_element_type_id => planning_element_type.id)
    ...
    describe '#color' do
      it 'can read the color w/ the help of the belongs_to association' do
        color                 = FactoryGirl.create(:timelines_color)
        planning_element_type = FactoryGirl.create(:timelines_planning_element_type,
                                               :color_id => color.id)
  ...
  describe '- Validations ' do
    ...
    describe 'name' do
      it 'is invalid w/o a name' do
        attributes[:name] = nil
        planning_element_type = Timelines::PlanningElementType.new(attributes)
  ...
  describe '#enabled_in?' do
    ...
    describe 'for projects' do
      ...
      describe 'when planning element type is enabled in given project' do
        before do
          project.timelines_planning_element_types << planning_element_type
        end
