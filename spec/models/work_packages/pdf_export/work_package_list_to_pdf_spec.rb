...
RSpec.describe WorkPackage::PDFExport::WorkPackageListToPdf do
  ...
  def work_package_details(work_package, index)
    [
      ...
      text_custom_field_a.name, work_package.custom_field_values.find { |cf| cf.custom_field == text_custom_field_a }.value,
      text_custom_field_b.name, work_package.custom_field_values.find { |cf| cf.custom_field == text_custom_field_b }.value
    ]
  end
  ...
  describe "with a request for a PDF Report default" do
