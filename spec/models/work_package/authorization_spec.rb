...
describe WorkPackage, "authorization" do
  include Spec::Models::Shared::Authorization

  let(:created_work_package) { FactoryGirl.create(:work_package,
                                                  :project => project,
                                                  :author => user) }
  ...
  it_should_behave_like "needs authorization for viewing", klass: WorkPackage,
                                                           instance: :created_work_package,
