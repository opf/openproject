...
RSpec.describe Queries::Filters::Strategies::CfString do
  ...
  describe ".supported_operators" do
    it "adds emptiness on top of the text operators" do
      expect(described_class.supported_operators).to match_array(%w[= ~ ! !~ !* *])
    end
  end
  ...
  describe "#operator" do
    ...
    # A custom value keeps its value in a string column, so an empty string is how "no value"
    # is stored: All on its own would match those rows too.
