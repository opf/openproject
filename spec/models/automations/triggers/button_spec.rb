...
RSpec.describe Automations::Triggers::Button do
  describe ".key" do
    it "derives from the class name" do
      expect(described_class.key).to eq(:button)
    end
  end

  describe ".human_name" do
    it "is the translated label" do
      expect(described_class.human_name).to eq("Button press")
    end
  ...
  describe "#human_name" do
    it "delegates to the class" do
      expect(described_class.new.human_name).to eq("Button press")
    end
  end

  describe "type" do
    let(:automation) { build(:automation, :with_button_trigger) }

    it "accepts a registered trigger type" do
      trigger = automation.button_trigger
