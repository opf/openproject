...
RSpec.describe Automations::Conditions::Status do
  it_behaves_like "associated custom condition" do
    ...
    describe "#allowed_values" do
      it "is the list of all status" do
        ...
        allow(Status).to receive_messages(select: Status, order: statuses)
    ...
    describe "#fulfilled_by?" do
      let(:work_package) { instance_double(WorkPackage, status_id: 1) }
