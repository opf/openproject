...
RSpec.describe Automations::Conditions::Project do
  it_behaves_like "associated custom condition" do
    ...
    describe "#allowed_values" do
      it "is the list of all projects" do
        ...
        allow(Project).to receive_messages(active: Project, select: Project, order: projects)
    ...
    describe "#fulfilled_by?" do
      let(:work_package) { instance_double(WorkPackage, project_id: 1) }
