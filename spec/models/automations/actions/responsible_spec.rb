...
RSpec.describe Automations::Actions::Responsible do
  let(:key) { :responsible }
  let(:type) { :user }
  let(:allowed_values) do
    ...
    allow(User).to receive_messages(not_locked: User, select: User,
                                    select_for_name: User, ordered_by_name: principals)
