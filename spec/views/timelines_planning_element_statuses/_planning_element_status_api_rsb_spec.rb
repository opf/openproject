...
describe 'timelines/timelines_planning_element_statuses/_planning_element_status.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/timelines_planning_element_statuses/planning_element_status.api', :object => planning_element_status)
  end

  describe 'with an assigned planning_element_status' do
    let(:planning_element_status) { FactoryGirl.build(:timelines_planning_element_status,
                                                  :id => 1,
