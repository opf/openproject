...
describe 'timelines/timelines_project_associations/_project_association.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/timelines_project_associations/project_association.api', :object => project_association)
  end
