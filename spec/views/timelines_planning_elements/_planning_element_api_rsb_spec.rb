...
describe 'timelines/timelines_planning_elements/_planning_element.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/timelines_planning_elements/planning_element.api', :object => planning_element)
  end
  ...
  describe 'with a planning element having a parent' do
    ...
    let(:parent_element)   { FactoryGirl.create(:timelines_planning_element,
                                            :id         => 1337,
                                            :name       => 'Parent Element',
                                            :project_id => project.id) }
    let(:planning_element) {  FactoryGirl.build(:timelines_planning_element,
  ...
  describe 'with a planning element having children' do
    ...
    before do
      FactoryGirl.create(:timelines_planning_element,
                     :project_id => project.id,
  ...
  describe 'with a planning element having a planning element type' do
    let(:planning_element_type) { FactoryGirl.create(:timelines_planning_element_type,
                                                 :id => 1342,
                                                 :name => 'Typ A') }
    let(:planning_element) { FactoryGirl.build(:timelines_planning_element,
  ...
  describe 'with a planning element having a planning element status' do
    let(:planning_element_status) { FactoryGirl.create(:timelines_planning_element_status,
                                                   :id => 1343,
                                                   :name => 'All well') }
    let(:planning_element) { FactoryGirl.build(:timelines_planning_element,
  ...
  describe 'with scenaric alternate dates' do
    ...
    let(:scenario_a) { FactoryGirl.create(:timelines_scenario,
                                      :project_id => project.id,
                                      :id   => 2001,
                                      :name => 'Scenario A') }
    let(:scenario_b) { FactoryGirl.create(:timelines_scenario,
                                      :project_id => project.id,
                                      :id   => 2010,
                                      :name => 'Scenario B') }
    let(:scenario_c) { FactoryGirl.create(:timelines_scenario,
                                      :project_id => project.id,
                                      :id   => 2030,
                                      :name => 'Scenario C') }
    let(:scenario_d) { FactoryGirl.create(:timelines_scenario,
                                      :project_id => project.id,
                                      :id   => 2100,
                                      :name => 'Scenario D') }
    ...
    before do
      @scenario_dates = [
        FactoryGirl.create(:timelines_alternate_scenaric_date,
