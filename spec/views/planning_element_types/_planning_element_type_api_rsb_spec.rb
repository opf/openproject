...
describe 'planning_element_types/_planning_element_type.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/planning_element_types/planning_element_type.api', :object => planning_element_type)
  end
