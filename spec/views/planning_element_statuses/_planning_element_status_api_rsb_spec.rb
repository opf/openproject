...
describe 'timelines/planning_element_statuses/_planning_element_status.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/planning_element_statuses/planning_element_status.api', :object => planning_element_status)
  end
