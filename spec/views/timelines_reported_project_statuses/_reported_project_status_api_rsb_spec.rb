...
describe 'timelines/timelines_reported_project_statuses/_reported_project_status.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/timelines_reported_project_statuses/reported_project_status.api', :object => reported_project_status)
  end

  describe 'with an assigned reported_project_status' do
    let(:reported_project_status) { FactoryGirl.build(:timelines_reported_project_status,
                                                  :id         => 1,
