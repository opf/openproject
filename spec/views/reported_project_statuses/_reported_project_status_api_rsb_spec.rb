...
describe 'timelines/reported_project_statuses/_reported_project_status.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/reported_project_statuses/reported_project_status.api', :object => reported_project_status)
  end
