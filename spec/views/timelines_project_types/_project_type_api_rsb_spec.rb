...
describe 'timelines/timelines_project_types/_project_type.api' do
  before do
  ...
  def render
    params[:format] = 'xml'
    super(:partial => 'timelines/timelines_project_types/project_type.api', :object => project_type)
  end

  describe 'with an assigned project_type' do
    let(:project_type) { FactoryGirl.build(:timelines_project_type, :id => 1,
