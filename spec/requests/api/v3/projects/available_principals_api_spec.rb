...
# This specs AvailableResponsibles as well as AvailableAssignees as both
# have a very similar behaviour

%w(assignees
   responsibles).each do |principals|

   describe "API::V3::Projects::Available#{principals.camelcase}API", type: :request do
