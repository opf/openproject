...
RSpec.describe API::V3::AI::TextTransformActionsByWorkPackageAPI,
  ...
  let(:path) { api_v3_paths.ai_text_transform_actions_by_work_package(work_package.id) }
  ...
  describe "GET /api/v3/work_packages/:id/ai_text_transform_actions" do
    ...
    context "for an invisible work package" do
      let(:path) { api_v3_paths.ai_text_transform_actions_by_work_package(create(:work_package).id) }
