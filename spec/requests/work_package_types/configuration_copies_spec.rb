...
RSpec.describe "Work package type configuration copies",
  ...
  describe "GET dialog" do
    ...
    it "is not found for aspects without a copy service" do
      get type_configuration_copy_dialog_path(type_id: type.id, aspect: Type::ConfigurationLink::PDF_EXPORT),
          as: :turbo_stream
  ...
  describe "POST copy" do
    ...
    it "is not found for aspects without a copy service" do
      post type_configuration_copy_copy_path(type_id: type.id, aspect: Type::ConfigurationLink::PDF_EXPORT),
           params: { source_id: source.id },
           as: :turbo_stream
