...
describe 'Work package calendars', type: :feature, js: true do
  ...
  it 'navigates to today, allows filtering, switching the view and retrains the state' do
    ...
    expect(page)
      .to have_selector '.fc-event', text: current_work_package.subject
    expect(page)
      .to have_selector '.fc-event', text: another_current_work_package.subject
    expect(page)
      .to have_no_selector '.fc-event', text: future_work_package.subject
    expect(page)
      .to have_no_selector '.fc-event', text: another_future_work_package.subject
    ...
    expect(page)
      .to have_no_selector '.fc-event', text: current_work_package.subject
    expect(page)
      .to have_selector '.fc-event', text: another_current_work_package.subject
    ...
    expect(page)
      .to have_no_selector '.fc-event', text: current_work_package.subject
    expect(page)
      .to have_no_selector '.fc-event', text: another_current_work_package.subject
    expect(page)
      .to have_no_selector '.fc-event', text: future_work_package.subject
    expect(page)
      .to have_selector '.fc-event', text: another_future_work_package.subject
    ...
    expect(page)
      .to have_no_selector '.fc-event', text: another_current_work_package.subject
    expect(page)
      .to have_selector '.fc-event', text: future_work_package.subject
    expect(page)
      .to have_selector '.fc-event', text: another_future_work_package.subject
    ...
    page.find('.fc-event', text: current_work_package.subject).click
    ...
    # click goes to work package show page
    expect(page)
      .to have_selector('.fc-event', text: current_work_package.subject, wait: 20)
