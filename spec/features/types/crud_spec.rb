...
RSpec.describe "Types", :js do
  ...
  it "toggles 'Active in new projects' from a type's 'Details' tab", with_flag: { type_variants: false } do
    expect(existing_type.default_variant.reload.enabled_in_new_projects?).to be false
    ...
    expect(existing_type.default_variant.reload.enabled_in_new_projects?).to be true
