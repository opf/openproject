...
RSpec.describe Automations::UpdateService do
  ...
  let(:instance) do
    contract
    described_class.new(automation:, user:)
  end
  let(:contract) do
    contract_instance = instance_double(Automations::CuContract)
    ...
    allow(contract_instance)
      .to receive_messages(validate: contract_success, errors: contract_errors)
  ...
  describe "#call" do
    ...
    it "is has the automation in the result" do
    ...
    it "sets the name of the automation" do
    ...
    it "updates the conditions" do
      ...
      automation.conditions = [Automations::Conditions::Status.new(old_status.id)]
