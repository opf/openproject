...
RSpec.describe OpenProject::JournalFormatter::ObservedInVersions do
  describe "#render" do
    ...
    # Unlike the target versions formatter, the label never falls back to the
    # single-version wording, the attribute having no such counterpart.
    let(:label) { "<strong>Observed versions</strong>" }
    ...
    context "when setting observed versions" do
    ...
    context "when changing observed versions" do
    ...
    context "when removing all observed versions" do
