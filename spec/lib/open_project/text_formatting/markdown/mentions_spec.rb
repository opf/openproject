            ...
            let(:expected) do
              <<~EXPECTED
                <p class="op-uc-p">
                  #{link_to(linked_project_member.name,
                            { controller: :users, action: :show, id: linked_project_member.id },
                            aria: { label: "#{linked_project_member.name}. A dynamic link to a user placed using a macro. User #{linked_project_member.name}" },
                            class: 'user-mention op-uc-link',
                            target: '_top',
                            data: {
                              hover_card_trigger_target: 'trigger',
                  ...
                  <p class="op-uc-p">
                    Link to
                      <a
                        ...
                        href="/users/#{user.id}"
                        aria-label="Foo Barrit. A dynamic link to a user placed using a macro. User Foo Barrit">Foo Barrit</a>
                  </p>
                EXPECTED
              end
            end
              ...
              <<~EXPECTED
                <p class="op-uc-p">
                  ...
                  <a class="user-mention op-uc-link"
                     ...
                     aria-label="#{linked_project_member_group.name}. A dynamic link to a group placed using a macro. Group #{linked_project_member_group.name}">
