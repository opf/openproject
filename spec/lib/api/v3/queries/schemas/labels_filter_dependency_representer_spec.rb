...
RSpec.describe API::V3::Queries::Schemas::LabelsFilterDependencyRepresenter do
  include API::V3::Utilities::PathHelper

  let(:query) { build_stubbed(:query) }
  let(:filter) { Queries::WorkPackages::Filter::LabelsFilter.create!(context: query) }
