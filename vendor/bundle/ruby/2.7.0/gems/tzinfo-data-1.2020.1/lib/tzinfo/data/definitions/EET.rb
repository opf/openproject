    ...
    module Definitions
      module EET
        ...
        timezone 'EET' do |tz|
          ...
          tz.transition 2068, 3, :o1, 3099862800, 59435173, 24
          tz.transition 2068, 10, :o0, 3118611600, 59440381, 24
          tz.transition 2069, 3, :o1, 3131917200, 59444077, 24
          tz.transition 2069, 10, :o0, 3150061200, 59449117, 24
          tz.transition 2070, 3, :o1, 3163366800, 59452813, 24
          tz.transition 2070, 10, :o0, 3181510800, 59457853, 24
        end
      end
    end
  end
