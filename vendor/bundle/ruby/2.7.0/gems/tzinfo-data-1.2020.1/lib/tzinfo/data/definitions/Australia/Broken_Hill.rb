      ...
      module Australia
        module Broken_Hill
          ...
          timezone 'Australia/Broken_Hill' do |tz|
            ...
            tz.transition 2065, 10, :o4, 3021813000, 39608995, 16
            tz.transition 2066, 4, :o3, 3037537800, 39611907, 16
            tz.transition 2066, 10, :o4, 3053262600, 39614819, 16
            tz.transition 2067, 4, :o3, 3068987400, 39617731, 16
            tz.transition 2067, 10, :o4, 3084712200, 39620643, 16
            tz.transition 2068, 3, :o3, 3100437000, 39623555, 16
            tz.transition 2068, 10, :o4, 3116766600, 39626579, 16
            tz.transition 2069, 4, :o3, 3132491400, 39629491, 16
            tz.transition 2069, 10, :o4, 3148216200, 39632403, 16
            tz.transition 2070, 4, :o3, 3163941000, 39635315, 16
          end
        end
      end
    end
