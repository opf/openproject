      ...
      FROM
       ...
       (
        ...
        FROM
          ...
          -- using a UNION to get the permissions that are not linked to a project module. This has two advantages:
          -- * the edge case of having projects but non has any module enabled is covered
          -- * due to the existence of a projects.id for all entrys, a costly "OR projects.id NULL" when joining can be avoided.
          UNION
