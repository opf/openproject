class AddPermissionInheritance < ActiveRecord::Migration
  def self.up
    add_column :group_users, :membership_type, :string, :null => false, :default => 'controller'
    add_column :member_roles, :membership_type, :string, :null => false, :default => 'controller'

    change_column :group_users, :membership_type, :string, :null => false, :default => 'default'
