...
ActiveRecord::Schema.define(:version => 20150729145732) do
  ...
  add_index "journals", ["journable_type", "journable_id", "version"], :name => "index_journals_on_journable_type_and_journable_id_and_version", :unique => true
  ...
  create_table "repositories", :force => true do |t|
    ...
    t.integer  "required_storage_bytes", :limit => 8,  :default => 0,  :null => false
