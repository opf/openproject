...
![Add and reorder widgets to the Home dashboard](2home_dashboard-add_widgets)
...
- Jump directly into relevant areas or items faster from your device home screen.
