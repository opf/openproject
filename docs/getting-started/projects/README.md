...
To view all your projects in which you are a member, click on the **Projects list** button in the action bar after opening the **Select a project** drop-down menu.
