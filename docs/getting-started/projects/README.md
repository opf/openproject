...
- **Copied from another project**: The project inherits the members and roles from the original project. See here [how to copy or duplicate a project](../../user-guide/projects/project-settings/project-information/#duplicate-a-project).
