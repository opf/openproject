...
- **Add predecessor** - adds a predecessor
- **Add follower** - adds a follower
- **Show relations** - open the details view of a work package, directly showing the tab **Relations**.
