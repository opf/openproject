...
Which templates you can choose from depends on the work package type. Administrators can [activate and deactivate the templates](../../../../system-admin-guide/manage-work-packages/work-package-types/pdf-export) for every work package type and change their order, which determines the template preselected in the dropdown menu.
