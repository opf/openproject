...
For each work package, a table of attributes is included, where attributes correspond to the columns you specified for the export. It is followed by the long text fields you selected, which support [embedded work package and project attributes](../../../wysiwyg/#attributes).

## Options

The following options are available for the PDF report:
