...
| [Disconnecting your Nextcloud and OpenProject accounts](#disconnecting-your-nextcloud-and-openproject-accounts) | Disconnecting your Nextcloud and OpenProject accounts        |
...
## Disconnecting your Nextcloud and OpenProject accounts

In certain cases, you may wish to disconnect your Nextcloud and OpenProject accounts. You might want to do this, for example, if you have multiple accounts and realise that you connected the wrong ones. 

Since OAuth credentials were generated by both Nextcloud and OpenProject when you connected your accounts, we recommend disconnecting on both ends.

#### In OpenProject

In OpenProject, click on your avatar on the top right corner and navigate to ***My account** → **Access tokens***. 

![OpenProject account settings page](my_account_access_tokens.png)

You will see a list of all access tokens associated with your account, including for a Nextcloud OAuth application. Click on **Revoke** and, in the confirmation dialog that appears, click **OK**.

#### In Nextcloud

Open your Nextcloud instance and navigate to _**Settings** → **Connected accounts**_. There, click on **Disconnect from OpenProject**.

You have now revoked both OAth access tokens and disconnected your OpenProject and Nextcloud accounts.

To re-establish a connection with different accounts (or to connect the same one again), simply follow [the above instructions](#connecting-your-openproject-and-nextcloud-accounts) again.
