...
In OpenProject you can view the files under _Repository_. Please keep in mind that from your OpenProject website you can only view or download the files. For committing new files you need an SVN- or Git-client.
