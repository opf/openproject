...
For more information, see the documentation on [displaying project attributes in work package forms](../../../../system-admin-guide/manage-work-packages/work-package-types/project-attributes/#display-project-attributes-in-work-packages).