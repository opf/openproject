...
14. **Set as template** or **Remove from templates**. By [setting a project as template](../../#create-a-project-template-premium-feature) it can be copied multiple times to create similar projects.
