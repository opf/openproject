...
**Project attributes** are a set of project-level custom fields that let you display certain types of information relevant to your project in the [Project home](../../project-home/) page.
...
You can use the **On/Off toggle** of each project attribute to enable or disable it in your project. Disabled project attributes are not visible in the [Project home](../../project-home/) page.
...
> [!TIP]
> The project settings page for project attributes only lets you enable or disable certain attributes. It does _not_ let you set the values for each. To do this, go to the [Project home](../../project-home/) page.
