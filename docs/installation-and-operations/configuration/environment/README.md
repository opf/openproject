...
OPENPROJECT_AI__TEXT__TRANSFORM__RUN__RETENTION__SECONDS (default=3600) How long finished AI text transform runs and their events are kept before a cron job removes them
