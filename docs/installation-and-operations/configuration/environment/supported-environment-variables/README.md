...
The default value is visible for each variable in parenthesis. The following are the correct values at the time of writing; use the rake task described under [Environment variables](../) to get the up-to-date list for your installation.
