...
- [ ] **Reorder priorities and set default types per project**, if you noted this as something to fix in the [Pre-Migration Checklist](https://www.openproject.org/docs/installation-and-operations/jira-migration/pre-migration-checklist/).
