...
- [FRONTEND](#frontend)
  ...
  * [Development Patterns](#development-patterns)
    ...
    + [Unidirectional data flow](#unidirectional-data-flow)
      ...
      - [2 main actors](#2-main-actors)
      - [Flow](#flow)
      - [Unidirectional data flow in the view / component’s tree](#unidirectional-data-flow-in-the-view---component-s-tree)
      - [What](#what-2)
      - [Why](#why-2)
    + [Components Architecture](#components-architecture)
      - [Services](#services)
        * [What](#what-3)
        * [Why](#why-3)
      - [Container Components (CC)](#container-components--cc-)
