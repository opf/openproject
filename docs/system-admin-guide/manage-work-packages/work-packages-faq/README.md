...
Make sure to uncheck the option "Only display statuses that are used by this type".
...
> [!NOTE]
> If you _delete_ a custom field (in the custom field configuration); its values will be deleted, too.
