...
OpenProject offers integration with XWiki for wiki collaboration. You can find more information about [setting up the integration with XWiki](./xwiki) and [using the integration](UPDATE LINK  )).
