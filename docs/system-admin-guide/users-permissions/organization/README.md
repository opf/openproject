...
> [!TIP]
> You can also import an existing organizational structure through [LDAP department synchronization](../../authentication/ldap-connections/ldap-department-synchronization/).
