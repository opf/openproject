...
This page explains the rules that decide user visibility and how administrators can widen it.
...
| **A and B are members of the same project** | Both are members of the same project. This also covers users who are not project members but have a work package in that project [shared](../../../user-guide/work-packages/share-work-packages) with them. |
...
- **Public projects are resulting in visibility.** Members of an active [public project](../../../user-guide/projects/project-settings/project-information/#make-a-project-public) are visible to everyone, including anonymous or non-member users depending on the "Login required" setting, because public projects are accessible to all.
...
If administrators want a user to be able to see all users and groups across the instance, assign a [global role](../roles-permissions/#create-a-new-global-role) that includes the **View all users and groups** permission to bypass any of the above constraints.
