---
title: OpenProject 17.0.4
sidebar_navigation:
    title: 17.0.4
release_version: 17.0.4
...
We released OpenProject [OpenProject 17.0.4](https://community.openproject.org/versions/2272).
...
- Bugfix: Mime Type detection can be tricked into sending params to the file tool \[[#72108](https://community.openproject.org/wp/72108)\]
- Bugfix: Meeting is set to in\_progress, when a user without the edit meetings permission starts the presentation \[[#72195](https://community.openproject.org/wp/72195)\]
